...
#   Author        : Fiix.one
#   Email         :
#   File Name     : qshell_install.sh
#   Last Modified : 2022-01-01 13:55
#   Describe      :
#
# ====================================================

cli_name="qshell"
url_start="https://github.com/qiniu/qshell/releases/download/v2.6.2/qshell-v2.6.2-linux-"
file_type=".tar.gz"
_log() {
    local logtype=$1
    local text
...
_install() {
    ...
    _log warn "Use: echo 'source <(qshell completion bash)' >> YOUR-USRE-HOME/.profile "
    _log warn "To:  Completion qshell Command "
}
